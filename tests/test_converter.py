...
from docstring2tsx.converter import class_to_data, serialize_module_data, process_member, get_class_ancestors
...
def test_process_member_handles_errors():
    ...
    with patch("docstring2tsx.converter.class_to_data", side_effect=mock_class_to_data):
